  ...
  return (
    <React.Fragment>
      <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="TPS" component={TpsIndex} options={{
          tabBarIcon: ({ color, size }) => (
            <Ionicons name="trash-bin" color={color} size={size} />
          ) 
        }}/>
        <Tab.Screen name='Relawan' component={EventIndex} options={{
          tabBarIcon: ({ color, size }) => (
            <Ionicons name="calendar-outline" color={color} size={size} />
          ) 
        }}/>
        <Tab.Screen name="Profile" component={ProfileIndex} options={{
          tabBarIcon: ({ color, size }) => (
