    ...
    <View style={styles.container}>
      <View style={styles.profileCard}>
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'start' }}>
          <Text style={{ fontWeight: 600, fontSize: 18, }}>Dimas Pramudya</Text>
          <Text style={{ fontSize: 12, }}>129836192369812</Text>
          <Text style={{ fontSize: 12, }}>Jl. Gatot Subroto, GG.10 No.10C, Samarinda, Bandara, Kalimantan Timur, Indonesia</Text>
        </View>
      </View>

      <View style={{ marginTop: 12 }}>
        <Text style={{ fontWeight: 600, fontSize: 18, marginBottom: 12 }}>Opsi</Text>
